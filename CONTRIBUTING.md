...
Thank you for your interest in contributing to pgtrgm! We appreciate your help
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/pgtrgm.git
   cd pgtrgm
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/martsokha/pgtrgm.git
   ```
